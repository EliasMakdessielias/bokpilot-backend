...
Totalsiffror (public-schemat, räknade ur databasen 2026-09-09): **128 tabeller** (samtliga med RLS aktivt), **0 vyer**, **264 egna funktioner** (exkl. extension-ägda), **85 triggrar**, **166 RLS-policies**, **199 index** (som inte backar constraints), **95 migrationer**, **33 edge functions**, **10 pg_cron-jobb**, **6 storage-buckets**. (Uppdaterat 2026-09-09 efter etapp 11b/11c — driftvakten bedömer bara avslutade körningar och `imap-import` är avregistrerad — samt kundappens sex migrationer samma dag: `byrastod_scope_v1`, `ai_kvot_v1`, `inbound_avsandare_v1`, `ai_kvot_v2`, `backup_underlag_v1` och `backup_underlag_v2` (se de två sista avsnitten); edge-funktionerna synkade mot driftsättningen 2026-09-09 kl. 09:46 UTC, då `backup-underlag` tillkom som nummer 33. Dessförinnan 2026-09-02 efter etapp 10–16: backupunderlag, driftövervakning, rollstyrning på lönetabellerna, KYC-datamodell med bucket, KYC-bevakning, append-only-skydd av operatörsloggen samt KYC-arkiv vid avveckling. Dessförinnan 2026-08-25 efter etapp 4–9: search_path-låsning och anon-indragning, täckande FK-index, RLS-InitPlan-omskrivning, behörighetskoll utan uid-beroende, indragna tabellrättigheter för anon, BFL-spärr vid bolagsradering samt nattlig avstämning mellan databas och Storage.) Inga egna enum-typer. Enda schema med egna objekt är `public`.
